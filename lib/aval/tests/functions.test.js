...
describe('aval', () => {
	describe('functions', () => {
		...
		test(
            'evals a block-less arrow function an keeps it in scope for later calling',
            () => {
                const expression = `
		...
		test(
            'evals a block arrow function an keeps it in scope for later calling',
            () => {
                const expression = `
		...
		test(
            'evals a block arrow function with arguments an keeps it in scope for later calling',
            () => {
                const expression = `
