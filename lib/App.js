...
class App extends React.PureComponent {
	...
	render() {
		...
		return (
			<div className="js_playground_container">
				<div className="js_playground_container__section">Evaluation</div>
				<pre>
					<code className="json hljs">{renderNode(ast, scopes)}</code>
				</pre>
				<div className="js_playground_container__section">File scope</div>
				<pre>
					<code className="json hljs">{reactify(scopes[0])}</code>
				</pre>
			</div>
		)
	}
